    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Teoria dos Jogos — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/teoria-dos-jogos" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Teoria dos Jogos — Matemática sem mistério | LotoAnalítica", descricao: "O dilema do prisioneiro: por que duas pessoas racionais chegam a um resultado coletivamente pior. Equilíbrio de Nash, Tit-for-Tat e teoria dos jogos no cotidiano.", caminho: "/matematica/teoria-dos-jogos" })
          ),
        }}
      />
