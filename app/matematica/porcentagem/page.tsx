    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Porcentagem — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/porcentagem" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Porcentagem — Matemática sem mistério | LotoAnalítica", descricao: "Por que 50% de desconto sobre o preço com 100% de aumento não te devolve ao preço original. Erros clássicos de porcentagem, juros compostos e variação percentual.", caminho: "/matematica/porcentagem" })
          ),
        }}
      />
