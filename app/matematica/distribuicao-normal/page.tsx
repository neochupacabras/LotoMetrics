    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Distribuição Normal — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/distribuicao-normal" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Distribuição Normal — Matemática sem mistério | LotoAnalítica", descricao: "A curva em forma de sino que governa altura, QI, erros industriais e somas de loteria. Entenda distribuição normal e o Teorema Central do Limite com visualização interativa.", caminho: "/matematica/distribuicao-normal" })
          ),
        }}
      />
