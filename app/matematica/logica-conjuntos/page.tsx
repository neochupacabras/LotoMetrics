    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Lógica e Conjuntos — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/logica-conjuntos" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Lógica e Conjuntos — Matemática sem mistério | LotoAnalítica", descricao: "Por que 'todos os gatos são animais' não significa que 'todos os animais são gatos'. Subconjuntos, silogismos e as falácias mais comuns no raciocínio cotidiano.", caminho: "/matematica/logica-conjuntos" })
          ),
        }}
      />
