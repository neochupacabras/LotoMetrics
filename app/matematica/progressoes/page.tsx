    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Progressões Aritméticas e Geométricas — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/progressoes" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Progressões Aritméticas e Geométricas — Matemática sem mistério | LotoAnalítica", descricao: "A diferença entre ganhar R$100 fixos por mês e dobrar seu dinheiro todo mês. PA e PG, crescimento linear vs exponencial com exemplos reais e simulador interativo.", caminho: "/matematica/progressoes" })
          ),
        }}
      />
