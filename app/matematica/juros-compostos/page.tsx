    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Juros Compostos — Matemática sem mistério | LotoAnalítica", caminho: "/matematica/juros-compostos" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Juros Compostos — Matemática sem mistério | LotoAnalítica", descricao: "O segredo que bancos sabem e a maioria ignora. Entenda juros simples vs compostos, a Regra do 72 e por que dívida de cartão de crédito cresce tão rápido.", caminho: "/matematica/juros-compostos" })
          ),
        }}
      />
      ...
      <main className="container secao" style={{ maxWidth: 760 }}>
        ...
        <p>
          ...
          sempre sobre os mesmos R$1.000. Após 10 anos: R$2.000.
        </p>
        <p>
          Em juros <strong>compostos</strong>, você ganha juros sobre o valor
          acumulado — incluindo os juros já ganhos. No 1º ano: +R$100 (agora tem R$1.100).
          No 2º: +R$110 (10% de R$1.100 = R$110). No 3º: +R$121. Os juros crescem
          todo ano porque a base cresce. Após 10 anos: R$2.593,74.
        </p>
        ...
        <div className="mat-formula">
          ...
          <div className="mat-formula__exemplo">
            ...
            15% ao mês (cartão) → 72÷15 = 4,8 meses para dobrar a dívida
          </div>
        </div>
        <p>
          A Regra do 72 é uma aproximação precisa para taxas entre 6% e 20%.
          Para taxas extremas o resultado é menos exato — mas ainda útil como
          estimativa mental rápida.
        </p>

        <h2 className="mat-h2">O lado sombrio: dívida de cartão de crédito</h2>
        <p>
          O mesmo mecanismo que enriquece investidores pacientemente destrói
          devedores. O rotativo do cartão de crédito no Brasil cobra taxas médias
          de 15% ao mês — uma das mais altas do mundo.
        </p>
        <p>
          Com 15% ao mês, pela Regra do 72: a dívida dobra em 72÷15 ≈ 4,8 meses.
          Em um ano, R$1.000 de dívida não paga vira R$1.000 × (1,15)¹² ≈ R$5.350.
        ...
        <div className="mat-box mat-box--rust">
          ...
          <p style={{ marginTop: 6 }}>
            O juro composto trabalha lentamente para investidores e rapidamente
            contra devedores. A diferença: a taxa mensal do cartão é o triplo da
            taxa anual típica de investimento — mas incide mensalmente.
          </p>
        </div>

        <h2 className="mat-h2">O poder do tempo: quem começa cedo vence</h2>
        <p>
          O maior aliado dos juros compostos não é a taxa — é o tempo. Considere:
        </p>
        <p>
          <strong>Ana</strong> investe R$5.000 por ano dos 25 aos 35 anos (10 anos)
          e depois para. Total investido: R$50.000.
        </p>
        <p>
          <strong>Bruno</strong> investe R$5.000 por ano dos 35 aos 65 anos (30 anos).
          Total investido: R$150.000.
        </p>
        <p>
          Com 8% ao ano, quem tem mais aos 65 anos? <strong>Ana</strong>, com
          R$787.000 contra R$611.000 de Bruno — apesar de ter investido R$100.000
          a menos. Os 10 anos de vantagem de Ana valem mais do que 30 anos de
          Bruno. Esse é o poder do tempo nos juros compostos.
        </p>

        <h2 className="mat-h2">Juros compostos e loteria</h2>
        <p>
          Quem joga R$20 por semana na Mega-Sena gasta R$1.040 por ano.
          Investindo esse valor a 8% ao ano em renda fixa por 30 anos, teria
          aproximadamente R$130.000 — graças aos juros compostos. Por{" "}
          <Link href="/matematica/valor-esperado" className="breadcrumb">
            valor esperado
          </Link>
          , a loteria devolve ~45% em prêmios. O custo de oportunidade de 30
          anos é enorme — mas o lazer e a expectativa têm valor real também.
        </p>
