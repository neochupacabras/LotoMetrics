    ...
    <>
      <BreadcrumbJsonLd
        itens={[
          ...
          { nome: "Calculadora de Regra de Três — LotoAnalítica", caminho: "/calculadoras/regra-de-tres" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: "Calculadora de Regra de Três — LotoAnalítica", descricao: "Resolva regra de três simples direta e inversa instantaneamente. Digite os três valores conhecidos e descubra o quarto. Com explicação do raciocínio.", caminho: "/calculadoras/regra-de-tres" })
          ),
        }}
      />
