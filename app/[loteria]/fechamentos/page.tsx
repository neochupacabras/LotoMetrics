...
> = {
  lotofacil:      { pool: 18, completo: 816, reduzido: 156, k: 12, sorteadas: 15 },
  megasena:       { pool: 10, completo: 210, reduzido: 27,  k: 4,  sorteadas: 6  },
  quina:          { pool: 8,  completo: 56,  reduzido: 9,   k: 3,  sorteadas: 5  },
  diadesorte:     { pool: 9,  completo: 36,  reduzido: 9,   k: 5,  sorteadas: 7  },
  maismilionaria: { pool: 8,  completo: 28,  reduzido: 7,   k: 4,  sorteadas: 6  },
  timemania:      { pool: 11, completo: 330, reduzido: 22,  k: 4,  sorteadas: 7  },
  duplasena:      { pool: 8,  completo: 28,  reduzido: 7,   k: 4,  sorteadas: 6  },
};
    ...
    <div className="container secao">
      ...
      <div className="bloco fechamento-explicacao" style={{ maxWidth: 680 }}>
        ...
        {ex ? (
          <>
            <p>
              Imagine que você está de olho em {ex.pool} dezenas da {loteria.nome},
              mas só pode jogar algumas delas em cada bilhete. O problema é: e se
              as {ex.sorteadas} dezenas sorteadas caírem espalhadas no meio do seu
              grupo de {ex.pool}? Você pode ter escolhido certo, mas se elas
              ficaram divididas entre bilhetes diferentes, nenhum bilhete
              individual acerta muitos pontos.
            </p>
            <p>
            ...
            <p>
              ...
              chance de as suas dezenas serem sorteadas</strong>. Escolher {ex.pool}{" "}
              dezenas não faz com que elas apareçam mais no sorteio — a probabilidade
              é exatamente a mesma que qualquer outra combinação de {ex.pool} dezenas
              teria.
            </p>
            <p>
          ...
          <>
            <p>
              ...
              mínimo</em> exigido pela aposta, e organizar jogos que garantem um
              prêmio mínimo se um certo número dessas dezenas sair. A {loteria.nome}{" "}
            ...
            <p>
              Se quiser aumentar sistematicamente a cobertura de uma aposta na{" "}
              {loteria.nome}, veja o{" "}
              <a href={`/${codigoLoteria}/gerador`}>gerador de jogos</a> ou o{" "}
              <a href={`/${codigoLoteria}/bolao`}>otimizador de bolão</a>.
            </p>
          </>
        )}
