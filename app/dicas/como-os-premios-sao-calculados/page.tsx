...
export default function ArtigoPremiosPage() {
  return (
    <>
      <BreadcrumbJsonLd
        itens={[
          { nome: "Dicas", caminho: "/dicas" },
          { nome: TITULO, caminho: "/dicas/como-os-premios-sao-calculados" },
        ]}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            articleJsonLd({ titulo: TITULO, descricao: DESCRICAO, caminho: "/dicas/como-os-premios-sao-calculados" })
          ),
        }}
      />
      <Masthead dicasAtiva />
