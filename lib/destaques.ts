...
function candidatosDoConcurso(
  ...
  if (analise.percentualParImpar !== null) {
    candidatos.push({
  ...
  if (analise.percentualSoma !== null) {
    candidatos.push({
  ...
  if (analise.percentualPrimos !== null) {
    candidatos.push({
  ...
  if (analise.percentualFibonacci !== null) {
    candidatos.push({
  ...
  if (analise.percentualMultiplos3 !== null) {
    candidatos.push({
  ...
  if (analise.percentualMolduraCentro !== null) {
    candidatos.push({
  ...
  if (analise.percentualSequencia !== null) {
    candidatos.push({
